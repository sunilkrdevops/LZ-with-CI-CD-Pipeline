...
vnets = {
  vnet1 = {
    name                = "vnet-sunil-prod"
    location            = "centralindia"
    resource_group_name = "rg-sunil-prod"
...
subnets = {
  snet1 = {
    ...
    resource_group_name  = "rg-sunil-prod"
    virtual_network_name = "vnet-sunil-prod"
...
vms = {
  frontend_1 = {
    ...
    location        = "centralindia"
    rg_name         = "rg-sunil-prod"
    nic_subnet_name = "frontend-subnet-prod"
    nic_vnet_name   = "vnet-sunil-prod"
    vm_name         = "frontend-vm-1-prod"
    vm_size         = "Standard_B1s"
    admin_username  = "devopsadmin"
    key_vault_name  = "kv-sunil-prod-9876"
